...
Sensitivity to the failure-cutoff definition was tested directly: a 40% cutoff yields a threshold severity of 1.487; 50% yields 1.142; 60% yields 0.855. Real hardware noise (Section 4, realistic calibration) corresponds to severity ≈ 0.03 on this scale, giving a robustness margin ranging from approximately 28× (60% cutoff, most conservative) to 50× (40% cutoff), centered at approximately 38× for the 50% cutoff.
